...
|---|---:|---:|---|---:|---:|---|
| temporal_pursuit | 8/8 | 100.0% | 67.6%–100.0% | 0 | 28.34 | {'success': 8} |
| temporal_mpc | 8/8 | 100.0% | 67.6%–100.0% | 0 | 32.68 | {'success': 8} |

区间按回合二项采样计算；同一生成器的样本有相关性，不能解释为真实道路泛化保证。

| 算法 | 场景族 | 成功 / 总数 | 平均进度 | 失败原因 |
|---|---|---:|---:|---|
| temporal_pursuit | straight | 1/1 | 98.3% | {} |
...
| temporal_pursuit | close_lines | 1/1 | 98.2% | {} |
| temporal_pursuit | repeated | 1/1 | 99.7% | {} |
| temporal_mpc | straight | 1/1 | 98.4% | {} |
| temporal_mpc | bend | 1/1 | 98.3% | {} |
| temporal_mpc | s_curve | 1/1 | 98.4% | {} |
